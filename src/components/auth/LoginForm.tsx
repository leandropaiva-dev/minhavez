    ...
    <div className="w-full">
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-500 mt-1 invisible">Placeholder</p>
        </div>
        ...
        <Button
          type="submit"
          disabled={loading}
          className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 h-auto text-base font-semibold shadow-lg shadow-blue-600/20 transition-all hover:shadow-xl hover:shadow-blue-600/30"
        >
          {loading ? (
        ...
        <Button
          ...
          variant="outline"
          className="w-full border-gray-300 hover:bg-gray-50 text-gray-700 py-3 h-auto text-base font-medium"
        >
        ...
        {/* Spacer to match signup form */}
        <p className="text-xs text-gray-500 text-center leading-relaxed invisible">
