    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
          ...
          <p className="text-zinc-400 text-sm mb-1">Total de Clientes</p>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
          ...
          <p className="text-zinc-400 text-sm mb-1">Tempo Médio Espera</p>
          <p className="text-3xl font-bold text-white">12min</p>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
          ...
          <p className="text-zinc-400 text-sm mb-1">Média Diária</p>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={hourlyData}>
              <CartesianGrid strokeDasharray="3 3" stroke="#27272a" />
              <XAxis dataKey="hora" stroke="#71717a" fontSize={12} />
              <YAxis stroke="#71717a" fontSize={12} />
              <Tooltip
                contentStyle={{
                  backgroundColor: '#18181b',
